...
const SvgComponent = (props: BottomTabProps) => (
  <Svg width={24} height={24} fill="none" {...props}>
    <G opacity={props.focused ? 1 : 0.1} fill="#2B24FF">
      ...
      <Path d="M17 7.75c-.19 0-.38-.07-.53-.22a.754.754 0 0 1 0-1.06l5-5c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-5 5c-.15.15-.34.22-.53.22Z" />
    </G>
  </Svg>
);
